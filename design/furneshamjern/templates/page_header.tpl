<div id="header">
                ...
                <div class="flags">
                	<a id="nor" class="flag active_flag" href="http://furnes-hamjern.no"></a>
                	<a id="swe" class="flag" href="http://furnes-hamjern.se"></a>
                ...
                {else}
                 ...
                 {/if}
                    ...
                    FDV</a>*}
                    <a href="content/view/sitemap/2"><img src={"sitemap_icon.png"|ezimage} />Nettstedskart</a>                
                </div>
</div>
